        ...
        <div id="administrasi" class="container tab-pane fade"><br>
         <table class="table table-bordered">
              ...
              <tr> <td>Sertifikat Produk</td> <td>
                ...
                {{ isset($ds->nama) ? $ds->nama : "" }} <br> {{ isset($ds->nomor_sertifikat) ? $ds->nomor_sertifikat : "" }} <br> <?php if(isset($data->dokumen_sertifikat)){ ?> <a href="{{asset('dokumen_sertifikat/'.$data->dokumen_sertifikat)}}" target="_blank" rel="noopener noreferrer">Lihat Dokumen</a> <?php } ?> <br> <br>
              <?php } ?> 
              </td> </tr>
          </table>
        </div>
