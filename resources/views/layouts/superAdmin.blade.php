    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <a href="/datastatistik" class="nav-link">   <!--merefer ke menu data statistik milik superadmin (views->statistikSuperAdmin.balde.php)-->
          ...
          <li class="nav-item">
           <a href="/dataperusahaan" class="nav-link"> <!--merefer ke menu data milik superadmin (views->dataSuperAdmin.blade.php)-->
           ...
           <li class="nav-item">
           <a href="/verifikasiPerusahaan" class="nav-link"> <!--merefer ke menu status verifikasi milik superadmin (views->verifikasiSuperAdmin.blade.php)-->
             <i class="nav-icon fas fa-table"></i>
              <p>
                Status Verifikasi
              </p>
           ...
           <li class="nav-item">
           <a href="/users" class="nav-link">   <!--merefer ke menu manajemen admin milik superadmin (views->users)-->
