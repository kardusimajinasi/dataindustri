...
class InputDataSuperAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('inputSuperAdmin', $data);
    }
    ...
    public function save(Request $request)
    {
        try {
            ...
            //mengambil data yiatu keterampilan dan jumlahnya untuk di simpan dalam perusahaan_keterampilan. Data ini bersifat array karena super admin dapat menginputkan banyak data.
    ...
    public function data($id_perusahaan=null)
    {
        ...
        $data = DB::table('data_pemilik')
            ...
            ->get();
        return view('dataSuperAdmin', compact('data'));
    }
      ...
      public function show($id_perusahaan)
    {
        ...
        return view('detailSuperAdmin', compact('data', 'data_pemilik', 'data_keterampilan', 'data_bpjs', 'data_sertifikat', 'data_pameran', 'data_pelatihan', 'data_bantuan_alat', 'data_bantuan_bahan'));
    }
    ...
    public function edit($id_perusahaan)
    {
        ...
        return view('editSuperAdmin', $data);
    }
    ...
    public function saveEdit($id_perusahaan, Request $request)
    {
        try {
            DB::beginTransaction();
     ...
     public function verifikasi($id_perusahaan=null)
    {
        ...
        return view('verifikasiSuperAdmin', compact('data'));
    }
    ...
    {   
        ...
        $data['data'] = DB::table('data_perusahaan')
            ...
            ->where('data_perusahaan.status', "=", '1')
            ->paginate(10);
        return view('statistikSuperAdmin', $data);
    }
    ...
    public function cetakData($id_perusahaan)
    {
        ...
        return view('cetakSuperAdmin', compact('data', 'data_pemilik', 'data_keterampilan', 'data_bpjs', 'data_sertifikat', 'data_pameran', 'data_pelatihan', 'data_bantuan_alat', 'data_bantuan_bahan'));
    }
